      ...
      >
        <div class="box">
          <el-card shadow="hover" :body-style="{ padding: '0px' }">
            <el-image
              :src="student.url"
              :preview-src-list="Array(student.srcList)"
              class="image"
            ></el-image>

            <!-- <img src="../assets/1.jpg" class="image" /> -->
            <div style="padding: 0 0 14px 28px; height: 110px">
  ...
  data() {
    return {
      ...
      scenerys: [
        ...
        {
          url: "http://img.lins-cqupt.cn/%E5%AE%9E%E9%AA%8C%E5%AE%A4%E6%B4%BB%E5%8A%A8/%E6%A0%A1%E5%86%85%E6%99%AF%E8%89%B25.jpg",
        },
        {
          url: "http://link.lins-cqupt.cn/5B27C29B54F4710B83039363C783AB3A.jpg",
        },
        {
          url: "http://link.lins-cqupt.cn/QQ图片20220703131913.jpg",
        },
        {
        ...
        {
          url: "http://link.lins-cqupt.cn/111E01856494325BA0BE15BD8EAB781C.jpg",
        },
        {
          url: "http://link.lins-cqupt.cn/A8148B06CFD07586F4EB3FD190017247.jpg",
        },
      ],
    };
  },
